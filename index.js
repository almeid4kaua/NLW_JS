...
const cadastrarMeta = async() => {
    ...
    if(meta.length == 0) {
        mensagem = 'Digite uma meta, por favor.'
        return //Futuramente, aplicar uma opção com duas alternativas, voltar para cadastrar ou sair...
    }
...
const metasRealizadas = async() => {
    ...
    await select({
        message: `Metas realizadas: ${realizadas.length} Metas`,
        choices: [...realizadas]
    })
}
